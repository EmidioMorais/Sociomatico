...
import com.example.hermenegildo.sociomatico.contoler.adapter.ListViewAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public  final  static  String POSITION_NOTICIA ="com.example.hermenegildo.sociomatico.POSITION_NOTICIA";
    ...
    public void noticia3() {
        Noticia noticia = new Noticia();
        noticia.setTituloNoticia("Nicki Minaj e rapper Nas já são Amigas");
    ...
    public void noticia6(){
        Noticia noticia = new Noticia();
        noticia.setTituloNoticia("Programacão ë Terrivel");
        noticia.setImagemAutor(R.drawable.zeca);
        noticia.setImagemNoticia(R.drawable.crianca);
        noticia.setAutorNoticia("Arilson Osvaldo");
        noticia.setDescricaoNoticia("fuck u");
